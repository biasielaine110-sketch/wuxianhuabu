  ...
  >
    ...
    <div className="min-h-8 py-1.5 bg-[#252525] border-b border-[#333] flex items-center justify-between px-3 cursor-grab active:cursor-grabbing shrink-0">
      ...
      {isSelected && (node.type === 't2i' || node.type === 'i2i' || node.type === 'panoramaT2i') && (
        <>
          <select className="nodemodel-select bg-[#222222] border border-[#444] rounded px-1.5 py-0.5 text-xs text-white outline-none focus:border-blue-500 flex-1 min-w-[90px]" value={normalizeLegacyImageModelId(node.model || defaultCanvasImageModel())} onChange={(e) => { const m = e.target.value; const patch: Partial<CanvasNode> = { model: m }; if (isHfsyGptImage2Pro4kModel(m) || isManxueGptImage24kModel(m)) patch.resolution = '4k'; else if (isToApisNanoBanana2Model(m) && (node.resolution || '2k').toLowerCase() === '4k') patch.resolution = '2k'; else if (isGptImage2CanvasModelId(m) || isManxueGptImage2Model(m)) patch.resolution = '2k'; s.handleUpdateNode(node.id, patch); }} onPointerDown={e => e.stopPropagation()}>
            {(node.type === 't2i' || node.type === 'panoramaT2i') ? (<><option value="gpt-image-2-codesonline">GPT Image 2（codesonline）</option><option value="gpt-image-2-vip">GPT Image 2 VIP（ToAPIs）</option><option value="gpt-image-2-official">GPT Image 2 Official（ToAPIs）</option><optgroup label="hfsyapi.cn"><option value="gpt-image-2-hfsy">GPT Image 2（hfsyapi.cn）</option><option value="gpt-image-2pro-hfsy">GPT Image 2 Pro（hfsyapi.cn）</option><option value="gpt-image-2pro-4k-hfsy">GPT Image 2 Pro 4K（hfsyapi.cn）</option><option value="nano-banana-2-hfsy">Nano-Banana 2（hfsyapi.cn）</option><option value="nano-banana-pro-hfsy">Nano-Banana Pro（hfsyapi.cn）</option></optgroup><optgroup label="阿里云百炼"><option value="z-image-turbo-aliyun">Z-Image-Turbo（阿里云百炼）</option><option value="qwen-image-3.0-pro-aliyun">Qwen-Image-3.0-Pro（阿里云百炼）</option></optgroup><optgroup label="ToAPIs"><option value="gpt-image-2">GPT Image 2（ToAPIs）</option><option value="qwen-image-3.0">Qwen-Image-3.0（ToAPIs）</option><option value="nano-banana-2">Nano-Banana 2（ToAPIs）</option><option value="imagen-4">Imagen 4</option></optgroup><optgroup label="满 e（manxueapi.com）"><option value="gemini-3.1-flash-image-preview-2k-manxue">Gemini 3.1 Flash Image 2K（满 e）</option><option value="gemini-3-pro-image-preview-2k-manxue">Gemini 3 Pro Image 2K（满 e）</option><option value="gpt-image-2-manxue">GPT Image 2（满 e）</option><option value="gpt-image-2-pro-manxue">GPT Image 2 Pro（满 e）</option><option value="gpt-image-2-4k-manxue">GPT Image 2 4K（满 e）</option><option value="gemini-3-pro-image-preview-4k-manxue">Gemini 3 Pro Image 4K（满 e）</option><option value="gemini-3.1-flash-image-preview-4k-manxue">Gemini 3.1 Flash Image 4K（满 e）</option></optgroup></>) : (<><option value="gpt-image-2-codesonline">GPT Image 2（codesonline）</option><option value="gpt-image-2-vip">GPT Image 2 VIP（ToAPIs）</option><option value="gpt-image-2-official">GPT Image 2 Official（ToAPIs）</option><optgroup label="hfsyapi.cn"><option value="gpt-image-2-hfsy">GPT Image 2（hfsyapi.cn）</option><option value="gpt-image-2pro-hfsy">GPT Image 2 Pro（hfsyapi.cn）</option><option value="gpt-image-2pro-4k-hfsy">GPT Image 2 Pro 4K（hfsyapi.cn）</option><option value="nano-banana-2-hfsy">Nano-Banana 2（hfsyapi.cn）</option><option value="nano-banana-pro-hfsy">Nano-Banana Pro（hfsyapi.cn）</option></optgroup><optgroup label="阿里云百炼"><option value="z-image-turbo-aliyun">Z-Image-Turbo（阿里云百炼）</option><option value="qwen-image-3.0-pro-aliyun">Qwen-Image-3.0-Pro（阿里云百炼）</option></optgroup><optgroup label="ToAPIs"><option value="gpt-image-2">GPT Image 2（ToAPIs）</option><option value="qwen-image-3.0">Qwen-Image-3.0（ToAPIs）</option><option value="nano-banana-2">Nano-Banana 2（ToAPIs）</option></optgroup><optgroup label="满 e（manxueapi.com）"><option value="gemini-3.1-flash-image-preview-2k-manxue">Gemini 3.1 Flash Image 2K（满 e）</option><option value="gemini-3-pro-image-preview-2k-manxue">Gemini 3 Pro Image 2K（满 e）</option><option value="gpt-image-2-manxue">GPT Image 2（满 e）</option><option value="gpt-image-2-pro-manxue">GPT Image 2 Pro（满 e）</option><option value="gpt-image-2-4k-manxue">GPT Image 2 4K（满 e）</option><option value="gemini-3-pro-image-preview-4k-manxue">Gemini 3 Pro Image 4K（满 e）</option><option value="gemini-3.1-flash-image-preview-4k-manxue">Gemini 3.1 Flash Image 4K（满 e）</option></optgroup></>)}
          </select>
