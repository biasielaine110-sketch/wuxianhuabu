...
export const CANVAS_SHORTCUT_HELP_ROWS: readonly { combo: string; detail: string }[] = [
  ...
  { combo: 'C', detail: '将选中节点的当前图片复制为新图片节点；视频则把当前预览成片粘贴为新视频节点（落在画布鼠标位置）' },
  ...
  { combo: 'Ctrl + C / ⌘ + C', detail: '有文字选区时复制文字；选中视频时把当前预览写入系统剪贴板；否则复制选中节点' },
  { combo: 'Ctrl + V / ⌘ + V', detail: '在输入框内粘贴文字；框外粘贴图片为新节点，或粘贴已复制节点' },
